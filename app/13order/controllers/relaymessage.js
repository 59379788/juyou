module.exports = function($scope, $uibModalInstance, code, relay, sale_belong, 
	...
	$scope.gogo = function(){
		...
		var fun;
		var para = {};
        if(sale_belong === 'juyou' || sale_belong.indexOf('supply_piaofutong') == 0 ||  sale_belong.indexOf('supply_tstc') == 0  ||  sale_belong === 'supply_tongchenglvyou' || sale_belong === 'supply_zhiyoubao' || sale_belong === 'supply_xiaojing' || sale_belong === 'supply_ziwoyou')
        {
            fun = relay;
